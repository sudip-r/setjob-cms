  ...
  <div class="card">
    <div class="card-body">
      <div class="form-group">
          {!! Form::label('page','Page Name') !!}
          {!! Form::text('page',null,['class' => 'form-control', 'id' => 'page', 'placeholder' => "Enter Page Name" ]) !!}
      </div>
   ...
   {{--
     <div class="form-group">
         @php $types = [''=>'Please Select', 'normal'=>'normal', 'block'=>'block'] @endphp
         {!! Form::Label('type', 'Type') !!}
         {!! Form::select('type', $types, $page->type??'', ['class' => 'form-control']) !!}
     </div>

     <div class="form-group">
         {!! Form::label('blocks',"Blocks") !!}
         {!! Form::textarea('blocks',null,['class'=>'textarea form-control blocks__box','id'=>'blocks','placeholder'=>'Enter Blocks']) !!}
     </div>
   --}}
    </div>
    ...
    <div class="card-footer">
        ...
        <a href="{!! route('cms::pages.index') !!}" title="Cancel" class="btn btn-danger cancel-btn">Cancel</a>
    </div>
      ...
      <div class="switch-box">
        <span class="switch-label">Active</span>
            <label class="switch">
                ...
                @if(isset($page) && $page->publish == '1' || old('publish'))
  ...
  <div class="card posts-box mt-30">
    <div class="card-header">
      ...
      <div id="featured_image">
        ...
        <img src="{!! $page->image !!}" alt="{!! $page->image !!}" style="width: 100%;height: auto;">
        @else
