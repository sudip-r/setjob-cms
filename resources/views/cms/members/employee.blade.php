        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
                ...
                <a href="{!! route('employee.detail',['user' => $user->slug]) !!}" class="btn btn-warning" data-bs-toggle="tooltip" data-placement="top" title="View user profile" target="_blank"><span class="fa fa-eye"></span></a>
