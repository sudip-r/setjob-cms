      ...
      <div class="row">
        <div class="col-md-6 search__box">
          <div class="input-group">
            <input class="form-control" alt="Category" route="{!! route('cms::members.employee.search') !!}" id="search_box" placeholder="Search (ID, Name or Email)" type="text" value="@if(isset($searchTxt)) {!! $searchTxt !!} @endif">
            <div class="input-group-addon search__icon" id="search-btn"><i class="ti-search"></i></div>
            @if(isset($searchTxt))
            <a href="{!! route('cms::members.employee') !!}" title="Cancel Search"><i class="fa fa-times cancel__search"></i></a>
            @endif
          </div>
        </div>
      </div>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
                ...
                <a href="{!! route('employee.detail',['slug' => $user->slug]) !!}" class="btn btn-warning" data-bs-toggle="tooltip" data-placement="top" title="View user profile" target="_blank"><span class="fa fa-eye"></span></a>
